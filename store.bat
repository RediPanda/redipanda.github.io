...
echo %LINE_VERT%                                              %LINE_VERT%
echo %LINE_VERT%                                              %LINE_VERT%
echo %CORNER_BL%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%LINE_HORI%%CORNER_LR%
set /p "cho=>"
IF %cho%==1 goto ITEM1
IF %cho%==2 goto ITEM2
IF %cho%==3 goto ITEM3
